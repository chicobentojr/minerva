...
const ChartsPage = () => {
  ...
  const tags = [...baseTags, { label: 'Outros', match: '' }]
  ...
  const othersData = useMemo(() => {
    return rawData.filter((r) => !baseTags.some(t => r.label.toLowerCase().includes(t.match)))
  }, [tags])
  ...
  return (
    <>
      ...
      <RawTable title='Others' rawData={othersData} />
    </>
  )
}
